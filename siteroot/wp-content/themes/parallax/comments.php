...
<?php if ( get_comment_type() == "comment" ) : ?>
						<li id="comment-<?php comment_ID() ?>" class="<?php sandbox_comment_class() ?>">
							<div class="comment-wrapper"><div class="comment-author vcard"><?php sandbox_commenter_link() ?></div>
							<div class="comment-meta"><?php printf(__('Posted %1$s at %2$s <span class="meta-sep">|</span> <a href="%3$s" title="Permalink to this comment">Link</a>', 'sandbox'),
										get_comment_date(),
										get_comment_time(),
										'#comment-' . get_comment_ID() );
										edit_comment_link(__('Edit', 'sandbox'), ' <span class="meta-sep">|</span> <span class="edit-link">', '</span>', '<span class="meta-sep">|</span>'); ?></div>
...
?> 	<p><input type="text" name="mcspvalue" id="mcspvalue" onfocus="if(this.value=='Type numbers, not text')value=''" onblur="if(this.value=='')value='Type numbers, not text';" value="Type numbers, not text" size="22" tabindex="4" />
	<label for="mcspvalue"><small><img style="margin-left:5px; padding:0; margin-bottom:-2px;" src="http://parallaxdenigrate.net/wp-content/themes/parallax/comspamimg/intro.gif" /> <img style="padding:0; margin-bottom:-2px;" src="http://parallaxdenigrate.net/wp-content/themes/parallax/comspamimg/<?php echo $mcsp_info['operand1'] . '" /> <img style="padding:0; margin-bottom:-2px;" src="http://parallaxdenigrate.net/wp-content/themes/parallax/comspamimg/and.gif" /> <img style="padding:0; margin-bottom:-2px;"  src="http://parallaxdenigrate.net/wp-content/themes/parallax/comspamimg/' . $mcsp_info['operand2'] . '" /> <img style="padding:0; margin-bottom:-2px;" src="http://parallaxdenigrate.net/wp-content/themes/parallax/comspamimg/huh.gif" />' ?> </small></label>
