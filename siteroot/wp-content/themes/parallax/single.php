<?php get_header() ?>
<!-- <div id="warnAboutSearches">
	Attention: If you followed an external link to this page you might not see what you expected due to some database-dickery. <br />If this seems to be the case, please do a search in the searchfield on the top of the sidebar and see if you find what you wanted.
</div> -->
	<div id="container">
		<div id="content">
